...
public class Interface {
    ...
    public static ArrayList<Ticket_office> object = new ArrayList<>();
    ...
    private static void save(ArrayList<Ticket_office> input) {
        int choose;
    ...
    private static ArrayList<Ticket_office> download() {
    	ArrayList<Ticket_office> output = new ArrayList<>();
        int choose;
        System.out.println("What type of saving do you wish for: ");
        System.out.println("1 - XML");
        System.out.println("2 - Standard Serialization");
    ...
    private static void sorters(ArrayList<Ticket_office> input) {
        int choose;
        settingAdvance();
        choose = in.nextInt();
        while (choose != 0) {
    ...
    private static void setting_search(ArrayList<Ticket_office> input) {
    ...
    private static void remove(ArrayList<Ticket_office> input) {
        int num;
        if (input.size() != 0) {
    ...
    private static void clear(ArrayList<Ticket_office> input) {
    ...
    private static String toStr(ArrayList<Ticket_office> input) {
