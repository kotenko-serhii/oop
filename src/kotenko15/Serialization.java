...
import ua.khpi.oop.kotenko12.Ticket_office;
...
public class Serialization {
    ...
    public static <E extends Ticket_office> ArrayList<E> LongTermPersistenceRead(String path) throws FileNotFoundException {
        boolean test = true;
    ...
    public static <E extends Ticket_office> void ObjectWrite(ArrayList<E> object, String path) throws IOException, ClassNotFoundException {
